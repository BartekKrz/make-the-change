        ...
        <div className="flex items-center gap-4 flex-wrap text-sm">
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-baseline gap-1">
              ...
              <span className="text-xs font-medium text-muted-foreground/70 uppercase tracking-wide">{t('stock.points_label')}</span>
            </div>
          </div>
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-baseline gap-1">
              ...
              <span className="text-xs font-medium text-muted-foreground/70 uppercase tracking-wide">{t('stock.label')}</span>
            </div>
          </div>
        </div>
