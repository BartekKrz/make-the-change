...
type Action =
  | { type: ActionType['ADD_TOAST']; toast: ToastType }
  | { type: ActionType['UPDATE_TOAST']; toast: Partial<ToastType> }
  | { type: ActionType['DISMISS_TOAST']; toastId?: ToastType['id'] }
  | { type: ActionType['REMOVE_TOAST']; toastId?: ToastType['id'] }
