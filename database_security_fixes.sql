-- =====================================================
-- SÉCURITÉ FIXES - PHASE 1: VUES SECURITY DEFINER DANGEREUSES
-- =====================================================
...
CREATE POLICY "Service role can view index analysis" ON public.index_usage_analysis_secure
...
CREATE POLICY "Service role can view table analysis" ON public.table_size_analysis_secure
    FOR SELECT USING (auth.jwt() ->> 'role' = 'service_role');
